...
public class PropertyTypeController {
	...
	public String displayPropertyType(ModelMap model) {     
            System.out.println("IN PropertyTypeController");
            model.addAttribute("titleName", "บันทึกรหัสที่ตั้งหลักทรัพย์");
            model.addAttribute("pageUrl", "SecuritiesSystem/Property/PropertyType.jsp");
            return "master/main";
	}
}
