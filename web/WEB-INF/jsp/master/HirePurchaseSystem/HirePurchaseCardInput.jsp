...
<div class="col-lg-10">
    ...
    <div class="row" style="text-align: center; background-color: #0088cc">
        <div class="span12" >รายละเอียดลูกหนี้เช่าซื้อ</div>        
    </div>
    <div class="row">&nbsp;</div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-2">รหัสลูกหนี้&nbsp;:</div>
        <div class="col-sm-2"><input type="text" name="cif" id="cif" maxlength="13" value="" /></div>
        <div class="col-sm-1">&nbsp;</div>
        <div class="col-sm-2">นำส่งภาษี&nbsp;:</div>
        <div class="col-sm-2">
    ...
    <div class="row">
        ...
        <div class="col-sm-1">&nbsp;</div>
        <div class="col-sm-2">อ้างอิงสินค้า&nbsp;:</div>
        <div class="col-sm-2"><input type="text" name="cif" id="cif" maxlength="13" value="" /></div>
    </div>
    <div class="row">            
    ...
    <div class="row">            
        <div class="col-sm-2">ชนิดภาษี&nbsp;:</div>
        <div class="col-sm-2">
            <select id="title" name="title" class="chosen-select-deselect " style="width:200px;">
                <option value="1">จ่ายนอก</option>
                <option value="2">คิดภาษี</option>
                <option value="3" selected="true">ไม่คิดภาษี</option>
            </select>
        </div>
        <div class="col-sm-1">&nbsp;</div>
        <div class="col-sm-2">อัตราภาษี&nbsp;:</div>
        <div class="col-sm-2"><input type="text" name="cif" id="cif" maxlength="13" value="7"/></div>
    </div>
    <div class="row">            
        <div class="col-sm-2">จำนวนงวด&nbsp;:</div>
        <div class="col-sm-2"><input type="text" name="cif" id="cif" maxlength="3" value="48"/></div>
        <div class="col-sm-1">&nbsp;</div>
        <div class="col-sm-2">ชำระงวดแรกวันที่&nbsp;:</div>
        <div class="col-sm-2"><input type="text" name="cif" id="cif" maxlength="13" value="20-08-2552"/></div>
    </div>
    <div class="row">            
        <div class="col-sm-2">ดอกเบี้ยทั้งสิ้น&nbsp;:</div>
        <div class="col-sm-2"><input type="text" name="cif" id="cif" maxlength="3" value="48,000.00"/></div>
        <div class="col-sm-1">&nbsp;</div>
        <div class="col-sm-2">รวมเงิน&nbsp;:</div>
        <div class="col-sm-2"><input type="text" name="cif" id="cif" maxlength="13" value="98,000.00"/></div>
    </div>
    <div class="row">            
        <div class="col-sm-2">รวมภาษี&nbsp;:</div>
        <div class="col-sm-2"><input type="text" name="cif" id="cif" maxlength="3" value="0.00"/></div>
        <div class="col-sm-1">&nbsp;</div>
        <div class="col-sm-2">รวมทั้งสิ้น&nbsp;:</div>
        <div class="col-sm-2"><input type="text" name="cif" id="cif" maxlength="13" value="98,000.00"/></div>
    </div>
    <div class="row">            
        <div class="col-sm-2">เงินต้น/งวด&nbsp;:</div>
        <div class="col-sm-2"><input type="text" name="cif" id="cif" maxlength="3" value="1,041.67"/></div>
        <div class="col-sm-1">&nbsp;</div>
        <div class="col-sm-2">ดอกเบี้ย/งวด&nbsp;:</div>
        <div class="col-sm-2"><input type="text" name="cif" id="cif" maxlength="13" value="1,000.00"/></div>
    </div>
    <div class="row">            
        <div class="col-sm-2">ภาษี/งวด&nbsp;:</div>
        <div class="col-sm-2"><input type="text" name="cif" id="cif" maxlength="3" value="0.00"/></div>
        <div class="col-sm-1">&nbsp;</div>
        <div class="col-sm-2">ค่าผ่อน/งวด&nbsp;:</div>
        <div class="col-sm-2"><input type="text" name="cif" id="cif" maxlength="13" value="2,041.67"/></div>
    </div>
    <div class="row">            
        <div class="col-sm-2">ผ่อน/งวดหลังปัดเศษ&nbsp;:</div>
        <div class="col-sm-2"><input type="text" name="cif" id="cif" maxlength="3" value="2,050.00"/></div>
        <div class="col-sm-1">&nbsp;</div>
        <div class="col-sm-2">ชำระทุกวันที่&nbsp;:</div>
        <div class="col-sm-2"><input type="text" name="cif" id="cif" maxlength="13" value="20"/></div>
    </div>
    <div class="row">
        <div class="col-sm-2">เงื่อนไขการชำระ&nbsp;:</div>
        <div class="col-lg-10"><textarea class="textareaCustom" type="text" name="addr1" id="addr1" cols="12" value=""></textarea></div>
    </div>
    <div class="row">            
        <div class="col-sm-2">รหัสผู้บันทึก&nbsp;:</div>
        <div class="col-sm-2"><input type="text" name="cif" id="cif" maxlength="3" value="A0001"/></div>
        <div class="col-sm-1">&nbsp;</div>
        <div class="col-sm-2">ชื่อผู้บันทึก&nbsp;:</div>
        <div class="col-sm-2"><input type="text" name="cif" id="cif" maxlength="13" value="นายทดสอบ ระบบ"/></div>
    </div>
    <div class="row">
