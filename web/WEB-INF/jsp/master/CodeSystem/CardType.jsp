<%-- 
    Document   : CardType
    Created on : Apr 20, 2014, 3:12:37 PM
    Author     : FUJITSU
--%>
        ...
        <div class="container" style='position:static;height:90%'>            
            <div class="col-lg-10" style="border-radius: 10px;float:right;padding-right:10px;z-index: 1;">
                ...
                <form:form modelAttribute="card" action="${url}" method="POST"> 
                    <div class="row"><div class="span10">บันทึกรหัสประเภทบัตร</div> </div>
                    <div class="row"><div class="span10">&nbsp;</div> </div>
                     <div class="row"> 
                            <div class="col-xs-3" style="text-align: right;">รหัสประเภทบัตร&nbsp;:</div>
                            <div class="col-xs-9">
                                <input class="input-append input" type="text" name="cardtypeid" id="cardTypeId" maxlength="4" value="${card.cardTypePK.cardtypeid}" disabled="true"/> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-9"><input class="input-append input" type="text" name="cardtypename" id="cardTypeName" maxlength="30" value="${card.cardtypename}" /></div>
                    </div>
                    <div class="row">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('#search').click(function(e) { // Button which will activate our modal
			   	$("#modal").load('<c:url value="/cardtype?search=1" />');
